...
CreateWindow :: proc(title: string, x, y, width, height: int, renderer: core.window_context = .opengl, extra_flags: []core.extra_window_flags = {}) -> core.window {
    r: sdl2.WindowFlags
    switch renderer {
        case .opengl:
...
CreateRenderContext :: proc(w: ^core.window, flags: []core.renderer_flags, index: i32 = -1) -> core.renderer {
